...
import { saveAction } from "../../redux/actions/user.action";
import { Link } from "react-router-dom";
import MaximeCatModal from "maxime-cat-modal";
import { modalHandle } from "../../redux/reducers/user.reducer";
...
function CreateEmployee() {
  ...
  const handleClose = () => dispatch(modalHandle(false));
  ...
  return (
    <div className="main-container">
      ...
      <Link className="link-page-employees" to="/employees">
          ...
          <FormControl fullWidth>
            ...
            >
              {states.map((state, item) => (
                <MenuItem key={item} value={state.name}>
                  {state.name}
                </MenuItem>
              ))}
            </Select>
